class GlobalNav extends HTMLElement {
    ...
    toggleMenu() {
        var _a;
        const menu = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.global-nav-menu-popover');
        if (menu) {
    ...
    handleClickOutside(event) {
        var _a, _b;
        const menu = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.global-nav-menu-popover');
        const menuButton = (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector('.global-nav-menu-button');
        // Check if the click was outside the menu and the button
        if (menu && menuButton) {
            const path = event.composedPath(); // Get the event path
    ...
    render() {
      ...
      `;
        ...
        const menuButton = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.global-nav-menu-button');
        if (!menuButton) {
            console.log("no menu button");
            return;
        }
        menuButton === null || menuButton === void 0 ? void 0 : menuButton.addEventListener('click', () => this.toggleMenu());
    }
}
